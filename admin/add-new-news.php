...
<body>
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            <div class="content">
                <h2 style="text-align: center;">Publish Latest News</h2><br><br>
                <form enctype="multipart/form-data" method="post">
                    <input type="text" name="txtname" placeholder="Enter News Title"> <br><br>
                    <input type="date" name="txtdate"> <br><br>
                    <input type="file" name="txtimage"> <br><br>
                    <input type="submit" value="Publish News" name="btninsert" class="update">
                </form>
                <?php 
                    if(isset($_POST['btninsert']))
                    {
                        ...
                        $imagePath = "img/newsImages/".$imageName;
                        move_uploaded_file($tmpName,$imagePath);
                        if(mysqli_query($connection,"INSERT INTO tbl_news(name,date,image) VALUES('$name','$date','$imagePath')"))
                        {
                            echo "
                            <script>
