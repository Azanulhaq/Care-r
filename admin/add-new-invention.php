...
<body>
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            <div class="content">
                <h2 style="text-align: center;">Add New Product</h2><br><br>
                <form enctype="multipart/form-data" method="post">
                    <input type="text" name="txtname" placeholder="Enter Product Name"> <br><br>
                    <input type="date" name="txtdate"> <br><br>
                    <input type="file" name="txtimage"> <br><br>
                    <input type="submit" value="Add Product" name="btninsert" class="update">
                </form>
                <?php 
                    if(isset($_POST['btninsert']))
                    {
                        ...
                        if(mysqli_query($connection,"INSERT INTO tbl_invention(name,date,image) VALUES('$name','$date','$imagePath')"))
                        {
                            echo "
                            <script>
