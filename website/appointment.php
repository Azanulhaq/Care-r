<?php 
    ...
    $select_patient = mysqli_fetch_array(mysqli_query($connection,"SELECT * FROM tbl_patient WHERE p_id=$p_id[p_id]"));
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="container">
            <div class="row gx-5">
                <div class="col-lg-6 py-5">
                    <div class="py-5">
                        <h1 class="display-5 text-white mb-4">Book your appointment with certified professional doctors</h1>
                        <p class="text-white mb-0">Health is an asset that helps us maintain the balance of life and a sound mind. It’s the true elixir for a happy life as it leads to a calm and composed mind.</p>
                    </div>
                </div>
                <div class="col-lg-6">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12 col-sm-6">
                                    <select class="form-select bg-light border-0" style="height: 55px;" id="doctors" name="txtdoctor">
                                            <option value="" hidden>Select Any Doctor</option>
                                        <script>
