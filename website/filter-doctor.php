<?php
    ...
    $name = $_POST['d_name'];
    $query = "SELECT tbl_doctor.*, tbl_specialization.* FROM tbl_doctor inner join tbl_specialization on tbl_doctor.specialization=tbl_specialization.sp_id WHERE d_name like '$name%' ";
