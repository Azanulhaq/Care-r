            ...
            <div class="row g-5">
                ...
                <div class="col-xl-4 col-lg-6 wow slideInUp" data-wow-delay="0.3s">
                    <form method="POST">
                        <div class="row g-3">
                            <div class="col-12">
                                <input type="text" class="form-control border-0 bg-light px-4" placeholder="Your Name" style="height: 55px;" name="txtname">
                            </div>
                            <div class="col-12">
                                <input type="number" class="form-control border-0 bg-light px-4" placeholder="Your Phone" style="height: 55px;" name="txtphone">
                            </div>
                            <div class="col-12">
                                <textarea class="form-control border-0 bg-light px-4 py-3" rows="5" placeholder="Message" name="txtmessage"></textarea>
                            </div>
                            <div class="col-12">
                    ...
                    <?php 
                        if(isset($_POST['btnsubmit']))
                        {
                            ...
                            if(mysqli_query($connection,"INSERT INTO tbl_feedback(name,phone,message) VALUES('$name','$phone','$message')"))
                            {
                                echo 
                                "<script>
                                    alert('Send ! Thank You For Your Feedback');
