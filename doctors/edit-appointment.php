<?php
    ...
    $select_patient = mysqli_fetch_array(mysqli_query($connection,"SELECT tbl_appointment.*,tbl_patient.* from tbl_appointment inner join tbl_patient on tbl_appointment.p_id=tbl_patient.p_id WHERE tbl_appointment.p_id=$select_patient_id"));
    ...
    $select_doctor = mysqli_fetch_array(mysqli_query($connection,"SELECT tbl_appointment.*,tbl_doctor.* from tbl_appointment inner join tbl_doctor on tbl_appointment.d_id=tbl_doctor.d_id WHERE tbl_appointment.d_id=$select_doctor_id"));
?>
<!DOCTYPE html>
<html lang="en">
<head>
